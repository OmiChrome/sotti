...
class Manager extends Employee {
    ...
    public void printBonus(){System.out.println(getName()+" : "+getSalary()/10);}
}

class Director extends Employee {
    Director(String n,double s){super(n,s);}
    public void printBonus(){System.out.println(getName()+" : "+getSalary()*15/100);}
}
